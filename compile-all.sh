rm -rf build/dc7-api-win-win32-ia32
rm -rf build/dc7-api-win-win32-x64
rm -rf build/dc7-api-darwin-x64
...
electron-packager ./dist ./build/dc7-api --platform=darwin --arch=x64  --asar --electron-version=1.6.10
electron-packager ./dist ./build/dc7-api-win --platform=win32 --arch=ia32 --asar --electron-version=1.6.10
electron-packager ./dist ./build/dc7-api-win --platform=win32 --arch=x64 --asar --electron-version=1.6.10

open ./build/dc7-api-darwin-x64/.
